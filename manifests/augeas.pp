...
class postfix::augeas {
  ...
  augeas::lens {'postfix_virtual':
    ...
    lens_content => file('postfix/postfix_virtual.aug'),
    test_content => file('postfix/test_postfix_virtual.aug'),
    stock_since  => '1.0.0',
  }
  augeas::lens {'postfix_canonical':
    ensure       => present,
    lens_content => file('postfix/postfix_canonical.aug'),
    test_content => file('postfix/test_postfix_canonical.aug'),
  }
}
